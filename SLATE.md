...
| `binge` | `true` = play this game start-to-finish without interleaving. By default the calendar **rotates** stream sessions among all in-progress games (alternating throughout the month); a binge game, once started, holds the rotation until it's done. |
